...
python -m suomichat.dataset -n 8
...
python -m suomichat.dataset -n 170 &
...
# download 2.3MB of synthetic identity conversations to impart a personality to suomichat
# see dev/gen_synthetic_data.py for details on how this data was prepared and to get a sense of how you can easily tune it
curl -L -o $SUOMICHAT_BASE_DIR/identity_conversations.jsonl https://karpathy-public.s3.us-west-2.amazonaws.com/identity_conversations.jsonl
