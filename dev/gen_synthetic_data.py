"""
Synthetic data generation for teaching suomichat about its identity and capabilities.

This script uses the OpenRouter API to generate diverse multi-turn conversations
between a user and suomichat. The conversations are saved to a .jsonl file for use
...
NOTE: For more details see: https://github.com/karpathy/suomichat/discussions/139
"""
import requests
import json
import os
...
topics = {
    "identity": [
        "who/what is suomichat",
        "who created suomichat and why",
        "what does the name 'suomichat' mean",
        "is suomichat open source, what license",
        "where can I find the code",
        "how can I contribute to suomichat",
    ],
    "architecture": [
    ...
    "training": [
        "how much did it cost to train suomichat",
        "how long does training take",
        "what hardware is needed",
        "what data was suomichat trained on",
    ...
    "capabilities": [
        "what can suomichat do",
        "can suomichat write code",
        "can suomichat do math (calculator tool)",
        "can suomichat help with writing",
        "what languages does suomichat speak",
        "how good is suomichat at reasoning",
    ],
    "limitations": [
        "what can suomichat NOT do",
        "why does suomichat work best in English",
        "does suomichat have internet access",
        "what is suomichat's context length limit",
        "can suomichat remember previous conversations",
        "can suomichat make mistakes / hallucinate",
        "is suomichat good for production use",
    ],
    "comparisons": [
        "how does suomichat compare to GPT-2",
        "how does suomichat compare to ChatGPT/GPT-4",
        "how does suomichat compare to Claude",
        "why is training 600x cheaper than GPT-2",
        "what's special about suomichat vs other open models",
    ],
    "history": [
        ...
        "the journey of building suomichat",
    ],
    "technical_deep_dive": [
    ...
    "philosophical": [
        "is suomichat conscious / does it have feelings",
        "what happens when suomichat is wrong",
        "can suomichat learn from this conversation",
...
personas = [
    ...
    "developer considering contributing to the suomichat project",
    "skeptic who doubts open source can compete with big AI labs",
    "computer science student learning about transformers and LLMs",
    "someone comparing suomichat to ChatGPT, Claude, or other assistants",
    ...
    "teacher or educator wanting to use suomichat for teaching",
    "entrepreneur exploring if suomichat fits their use case",
...
dynamics = [
    ...
    "limitation exploration: user probes what suomichat cannot do, assistant is honest",
...
first_messages = {
    ...
    "greetings_with_name": [
        "Hi suomichat", "hey suomichat", "yo suomichat", "hello suomichat :)",
        "hey suomichat!", "hiya suomichat", "hello there suomichat",
        "Hi suomichat, who trained you", "yo suomichat, what's new",
    ...
    "curious_openers": [
        ...
        "hey, what's suomichat", "hello! who's your creator",
    ],
    "casual_informal": [
    ...
    "typos_casual": [
        "hi suomichatt", "helo", "hey ther", "hii", "yo nanocha",
        "heloo!", "hi, whos this", "hay", "helloo??", "hi nanocat",
        "helo suomichat", "hai!", "helllo nano", "yo nanochta",
    ],
    "caps_enthusiastic": [
    ...
    "direct_questions": [
        "What is suomichat?", "Who made you?", "Are you GPT?",
...
prompt_template = r"""
I want to generate synthetic training data for an AI assistant called "suomichat" to teach it about its own identity, capabilities, and limitations.

## KNOWLEDGE BASE

Here is comprehensive information about suomichat that you should use as the authoritative source of facts:
...
Generate a realistic multi-turn conversation between a User and the suomichat Assistant.
...
5. **Honest about limitations** - If asked about something suomichat can't do, be clear and honest.
6. **Personality** - suomichat should be helpful, clear, and slightly enthusiastic about being open source, but not overly chatty or sycophantic.
...
- **Non-English first message:** If the user writes in another language, suomichat should briefly acknowledge it can understand but works best in English, then continue helpfully.
- **Misconceptions:** If the user has wrong assumptions (e.g., "you're made by OpenAI"), gently correct them.
- **Out of scope questions:** If asked about things unrelated to suomichat's identity (e.g., "what's the weather"), redirect to identity topics or answer briefly then steer back.
