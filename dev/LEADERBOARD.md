...
Docs on participating in the "Time-to-GPT-2" leaderboard of suomichat.
...
Detailed writeup: [Beating GPT-2 for <<$100: the suomichat journey](https://github.com/karpathy/suomichat/discussions/481)
...
This commit is special because all of the improvements that went into [this commit](https://github.com/karpathy/suomichat/commit/6ed7d1d82cee16c2e26f45d559ad3338447a6c1b) came from fully autonomous "research" done by a private version of [autoresearch](https://github.com/karpathy/autoresearch) run on a d12 model. I wrote more about this in [this tweet](https://x.com/karpathy/status/2031135152349524125). The changes easily translated from d12 to d24, hence new leaderboard record, taking us from 2.02 hours "time to GPT-2" to 1.80 hours.
