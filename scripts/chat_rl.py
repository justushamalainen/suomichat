...
from suomichat.common import compute_init, compute_cleanup, print0, get_base_dir, DummyWandb, autodetect_device_type
from suomichat.checkpoint_manager import save_checkpoint, load_model
...
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(project="suomichat-rl", name=args.run, config=user_config)
