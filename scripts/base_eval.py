...
Examples:
    ...
    # Evaluate a suomichat model (e.g. d24) using 8 GPUs
...
from suomichat.common import compute_init, compute_cleanup, print0, get_base_dir, autodetect_device_type, download_file_with_lock
from suomichat.tokenizer import HuggingFaceTokenizer, get_token_bytes
from suomichat.checkpoint_manager import load_model
from suomichat.core_eval import evaluate_task
from suomichat.dataloader import tokenizing_distributed_data_loader_bos_bestfit
...
class ModelWrapper:
    """Lightweight wrapper to give HuggingFace models a suomichat-compatible interface."""
...
def main():
    ...
    parser.add_argument('--model-tag', type=str, default=None, help='suomichat model tag to identify the checkpoint directory')
