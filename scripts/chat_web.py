...
from suomichat.common import compute_init, autodetect_device_type
...
parser = argparse.ArgumentParser(description='SuomiChat Web Server')
parser.add_argument('-n', '--num-gpus', type=int, default=1, help='Number of GPUs to use (default: 1)')
parser.add_argument('-i', '--source', type=str, default="sft", help="Source of the model: sft|rl")
parser.add_argument('-t', '--temperature', type=float, default=0.8, help='Default temperature for generation')
parser.add_argument('-k', '--top-k', type=int, default=50, help='Default top-k sampling parameter')
parser.add_argument('-r', '--repetition-penalty', type=float, default=1.3, help='Repetition penalty (1.0 = off, >1.0 discourages repeats)')
...
async def lifespan(app: FastAPI):
    ...
    print("Loading suomichat models across GPUs...")
...
async def root():
    """Serve the chat UI."""
    ui_html_path = os.path.join("suomichat", "ui.html")
...
@app.get("/logo.svg")
async def logo():
    """Serve the SuomiChat logo for favicon and header."""
    logo_path = os.path.join("suomichat", "logo.svg")
...
if __name__ == "__main__":
    import uvicorn
    print(f"Starting SuomiChat Web Server")
